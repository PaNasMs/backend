...
package="$repo/dist/panasms-prototype_0.2.1_${arch}.deb"
install -o "$admin" -g "$(id -gn "$admin")" -m 0644 "$scratch/backend/dist/panasms-prototype_0.2.1_${arch}.deb" "$package"
if [[ $disk_fan == 1 ]]; then
